...
loader = DirectoryLoader(
    path=project_root / "data" / "new_articles", glob="*.txt", loader_cls=TextLoader
)
...
persits_directory = str(project_root / "db" / "chroma_langchain_test")
...
# Create a chain that combines documents and generates answers using the LLM interface
